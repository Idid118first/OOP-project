...
// This is the third in line subclass of Ticket and has methods identical to steerageTicket (another subclass of Ticket); please refer to that class for specific comments regarding implementation details.
public class coachTicket extends Ticket{
    ...
    public void chooseOptions(Scanner scanner) {
        ...
        while (selecting) {
            System.out.println("\n\nYou may also opt for these Coach Class Ticket Options (for an additional fee, of course: ");
            System.out.println("1. Handrail");
            System.out.println("2. Carry-on bag");
            System.out.println("3. Done selecting options");
            System.out.print("\nEnter your choice (1-3, you may also select 3 if you wish not to opt for any of these upgrades... cheapskate): ");

            if (scanner.hasNextInt()) {
                int choice = scanner.nextInt();
                switch (choice) {
                    case 1:
                        selectedOptions.add("Handrail");
                        optionCount ++;
                        break;
                    case 2:
                        selectedOptions.add("Carry-on bag");
                        optionCount ++;
                        break;
                    case 3:
                        selecting = false;
                ...
                System.out.println("\nInvalid input. Please enter an integer number within bounds.");
                scanner.next();
            }
        }
    }
